    ...
    return (
        <div className="border-b border-gray-800 p-4">
            ...
            <div className="flex justify-between items-center mt-4">
                ...
                <button className="bg-white text-twitter-background font-bold px-4 py-2 rounded-full hover:bg-opacity-85 transition duration-200" onClick={handleSubmit}>Postar</button>
            </div>
        </div>
    )
}
